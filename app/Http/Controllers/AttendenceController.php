...
class AttendenceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Apply general setting status if available
    ...
    /**
     * Update attendance records for an employee on a specific date and recalculate payroll.
     *
     * @param Request $request
    ...
    public function update(Request $request, $employee_id)
    {
        ...
        // Recalculate payroll for the employee and month
        try {
            $payrollController = new PayrollController();
            $month = $date->format('Y-m'); // Format: YYYY-MM
    ...
    /**
     * Delete attendance records for an employee on a specific date and recalculate payroll.
     *
     * @param Request $request
     * @param int $employee_id
     * @return \Illuminate\Http\JsonResponse
    ...
    public function destroy(Request $request, $employee_id)
    {
        ...
        // Find and delete attendance record for the employee and date
        $attendance = Attendence::where('employee_id', $employee_id)
            ->whereDate('date', $date)
            ->first();
    ...
    /**
     * Calculate late duration in hours based on check-in time.
     *
    ...
    /**
     * Calculate overtime duration in hours based on check-out time.
     *
     * @param Employee $employee
    ...
    private function calculateOvertime($employee, $checkOutTime)
    {
        ...
        $overtimeMinutes = $actualTime->diffInMinutes($defaultTime, false);
